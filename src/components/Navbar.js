...
const Navbar = () => {
  ...
  return (
    <nav
      className={`sticky top-0 z-50 bg-animated-gradient bg-[length:200%_200%] animate-gradient-x text-gray-900 transition-all duration-300 ${
        scrolled ? "border-b-2" : "border-b-4"
      }`}
    >
        ...
        <div className="flex items-center justify-between h-24">
          ...
          <div className="hidden lg:flex items-center gap-12 flex-1 justify-end">
                ...
                <li key={link.name}>
                  ...
                  <a
                    ...
                    className={`font-semibold text-base transition-colors duration-300
                      ${
                        currentPage === link.url.slice(1) ||
                        (link.url === "/" && currentPage === "home")
                          ? "text-gray-900"
            ...
            <div className="flex items-center gap-6">
              ...
              <button
                className="flex items-center gap-2 bg-black text-white px-6 py-2.5 rounded-full font-bold text-sm hover:bg-gray-800 transition-all duration-300 hover:scale-105 shadow-md"
      ...
      >
        <div className="bg-white/50 backdrop-blur-sm border-t-2 border-black px-6 py-6 space-y-6">
            ...
            {navLinks.map((link) => (
              <li key={link.name}>
                <a
                  ...
                  className={`block font-bold text-lg py-2 px-4 rounded-lg transition-all duration-300 ${
                    link.isActive
                      ? "bg-black text-white"
          ...
          <div className="flex flex-col gap-4 pt-4 border-t-2 border-black/20">
            ...
            <button
              className="flex items-center justify-center gap-2 bg-black text-white px-6 py-3 rounded-full font-bold text-base hover:bg-gray-800 transition-all duration-300 shadow-md mx-auto w-full max-w-xs"
              onClick={() => navigate("/donate")}
            >
